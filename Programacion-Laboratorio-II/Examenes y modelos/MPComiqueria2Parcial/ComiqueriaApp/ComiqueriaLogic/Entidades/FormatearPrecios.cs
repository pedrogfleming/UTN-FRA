...
{    
    public static class FormatearPrecios
    {
        /// <summary>
        /// 1)Crear en una nueva clase un método de extensión “FormatearPrecio” que extienda el tipo Double
        ...
        {   
            ...
            return string.Format("${0:0.00}", numero.ToString());
        }
