...
namespace Entidades
{
    public class Alumno : IIdentifier
    {
        ...
        public Alumno():this(0,"","",0,18,EGenero.otro)
        {
        }
        public Alumno(int id,string nombre,string apellido,int dni,short edad,EGenero genero)
        {
            this.id = id;
            this.Nombre = nombre;
        ...
        {
            return $"{this.Id} {this.Apellido} {this.Nombre} {this.Dni} {this.Genero} {this.edad}";
        }
        #endregion
        #region Metodos
        /// <summary>
            ...
            if (listaBase is not null && !string.IsNullOrWhiteSpace(atributo) && !string.IsNullOrWhiteSpace(keyWord))
            {
                ...
                switch (atributo)
                {
                    ...
                    case "dni":
                        ...
                        break;
                    case "genero":
                        auxLista.Add(listaBase.Find((a) => a.Genero.ToString() == keyWord));
                        break;
                    case "edad":
                        auxLista.Add(listaBase.Find((a) => a.Edad.ToString() == keyWord));
                        break;
                    default:
                        break;
                }
