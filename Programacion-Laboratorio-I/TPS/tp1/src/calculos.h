...
int factorial(int numero,int* pAux);
...
//Brief Muestra los resultados obtenidos de 5 operatorias en función de dos numeros enteros
//(suma,resta,division,multiplicacion y factorial de cada uno)
//recibe como parametros 8 int y un float(para mostrar la division con coma)
//no retorna nada
#endif /* CALCULOS_H_ */
